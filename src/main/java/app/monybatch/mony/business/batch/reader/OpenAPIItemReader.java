...
public class OpenAPIItemReader<T> extends OpenAPIBaseReader<T> implements ItemReader<T> {
    ...
    public OpenAPIItemReader(Class<T> clazz, MultiValueMap<String, String> params, String key, String path, app.monybatch.mony.system.core.constant.DataType datatype, ConcurrentHashMap<String, String> headers) {
        super(clazz, params, key, path, datatype, headers);
    }

    public OpenAPIItemReader(Class<T> clazz, MultiValueMap<String, String> params, String key, String path, app.monybatch.mony.system.core.constant.DataType datatype, ConcurrentHashMap<String, String> headers, String isuSrtCd) {
