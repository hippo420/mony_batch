package app.monybatch.mony.batch.report.job;

import app.monybatch.mony.batch.support.parameter.DescriptiveJob;
import app.monybatch.mony.batch.report.reader.ReportWebReader;
import app.monybatch.mony.infra.llm.GeminiApiClient;
import app.monybatch.mony.batch.report.writer.ReportFileWriter;
