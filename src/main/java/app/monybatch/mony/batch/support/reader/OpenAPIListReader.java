...
public class OpenAPIListReader<T> extends OpenAPIBaseReader<T> implements ItemReader<List<T>> {
    ...
    public OpenAPIListReader(Class<T> clazz, MultiValueMap<String, String> params, String key, String path, DataType datatype) {
        super(clazz, params, key, path, datatype, null);
    }

    public OpenAPIListReader(Class<T> clazz, MultiValueMap<String, String> params, String key, String path, DataType datatype, ConcurrentHashMap<String, String> headers) {
