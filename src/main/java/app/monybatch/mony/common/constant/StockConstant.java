...
public class StockConstant {
    ...
    public static String KRX_KOSPI_TRX_URL = "/svc/apis/sto/stk_bydd_trd";
    public static String KRX_KOSDAQ_TRX_URL = "/svc/apis/sto/ksq_bydd_trd";
    public static String KRX_KONEX_TRX_URL = "/svc/apis/sto/knx_bydd_trd";
